...
public class NVfullTime {
    ...
    public NVfullTime(String ID, String name, String telephone, String address, int numberWorkDay) {
        this.ID = ID;
        this.name = name;
    ...
    public Double getSalary() {
        return 1.0*numberWorkDay*1500000;
    }
    ...
    public void display(){
        ...
        System.out.println("NumberWorkDay: "+numberWorkDay);
    }
}
