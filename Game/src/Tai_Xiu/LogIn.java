...
public class LogIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 180, 190, -1));

        jPasswordField1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        getContentPane().add(jPasswordField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 230, 190, -1));
        ...
        jLabel5.setText("TAI & XIU");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 10, -1, -1));

        jTextField2.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 132, 190, 30));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/cap-nhat-thong-tin-lien-quan-den-cac-tool-tai-xiu-danh-cho-cac-tay-cuoc.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(jTextField1.getText().equals("") && jPasswordField1.getText().equals("")){
            JOptionPane.showMessageDialog(this, "Please input Your user and Password!");
        }else if(jTextField1.getText().equals("vincenzoKay") && jPasswordField1.getText().equals("2462006")){
            JOptionPane.showMessageDialog(this, "Log In successfull!");            
            viewTX vi = new viewTX();
            vi.setVisible(true);
            vi.setLocationRelativeTo(null); 
            vi.setTen(jTextField2.getText());
            this.dispose();
        }else{
            JOptionPane.showMessageDialog(this, "Your user or Password is Wrong!");
            jTextField1.setText("");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        fs.setVisible(true); fs.setLocationRelativeTo(null);
        this.dispose();
