...
public class Cart { // giỏ hàng chứa products
    ...
    public Product getProductFromBasket(String id){
    ...
    //===========================================//
    public void removeItem(Product p, ShopProduct sp){ // bỏ product ra khỏi giỏ khi đổi ý ko mua
        p.setQuantity(p.getQuantity()-1);
        if(p.getQuantity()==0){
           basket.removeIf(pro -> pro.equals(p));         
        }
