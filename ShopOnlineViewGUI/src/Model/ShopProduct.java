...
public class ShopProduct{
   ...
   //===========================================================//
    ...
    //=================================================================//
    public Product searchSPbyID(String id ,ArrayList<Product> shp){
    ...
    public ArrayList<Product> searchSPbyPrice(ShopProduct sp, Predicate<Product> pr){
        ArrayList<Product> listSPprice = new ArrayList<>();
        for (Product pro : sp.getShop()) {
            if(pr.test(pro)) listSPprice.add(pro);
        }
        return listSPprice;
    }
    //====================================================================//
    
    public Vector<Vector> getData(ArrayList<Product> ch){
    ...
    //====================================================================//
    public void readShop(String fName){
        try {
    ...
    //======================================================================//
    public void saveShop(String fname){
        try {
    ...
    public Product getProductFromShop(String id){
        for (Product p : shop) {
